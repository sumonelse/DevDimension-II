            ...
            <div className="container mx-auto px-4 md:px-6 relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
                    {skillCategories.map((category, index) => (
                        ...
                        >
                            <div
                                className={`h-full tilt-card clay bg-dark-900 rounded-xl p-8 transition-all duration-500 group relative overflow-hidden animate-slide-up border border-${category.color}-500/20 hover:border-${category.color}-500/50`}
                                style={{
                            ...
                            >
                                ...
                                <div
                                    className={`absolute -top-10 -right-10 w-40 h-40 rounded-full blur-xl opacity-70 group-hover:opacity-100 transition-opacity duration-700 bg-${category.color}-500/5`}
                                ></div>
                                <div
                                    className={`absolute -bottom-10 -left-10 w-40 h-40 rounded-full blur-xl opacity-70 group-hover:opacity-100 transition-opacity duration-700 bg-${category.color}-500/5`}
                                ></div>
                                ...
                                <div className="tilt-card-inner relative z-10">
                                    ...
                                    <div className="flex items-center mb-8 tilt-card-content">
                                        <div
                                            className={`w-12 h-12 rounded-xl flex items-center justify-center mr-4 text-white transition-all duration-300 group-hover:scale-110 animate-subtle-pulse bg-gradient-to-br from-${category.color}-600 to-${category.color}-400 shadow-lg shadow-${category.color}-500/20 group-hover:shadow-${category.color}-500/40`}
                                            style={{
                                                animationDelay: `${
                                                    index * 200
                                                }ms`,
