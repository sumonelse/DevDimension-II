  ...
  const handleSubmit = e => {
    ...
    setTimeout(() => {
      setFormStatus({
        submitted: true,
        submitting: false,
        info: { error: false, msg: "Thanks for your message! I'll get back to you soon." }
      });
              ...
              <div className="space-y-8">
                <div className="flex items-start gap-5 group">
                  ...
                  <div className="transition-all duration-300 group-hover:translate-x-1">
                    ...
                    <a href="mailto:sumit.maurya@example.com" className="text-gray-400 hover:text-purple-400 transition-colors duration-300">sumit.maurya@example.com</a>
                  </div>
                </div>
                ...
                <div className="pt-6">
                  ...
                  <div className="flex gap-4">
                    ...
                    <a 
                      href="#" 
                      className="w-12 h-12 bg-dark-900 rounded-full flex items-center justify-center text-gray-400 hover:text-purple-400 hover:shadow-neon transition-all duration-300 hover:-translate-y-1"
                      aria-label="GitHub"
                    >
                    ...
                    <a 
                      href="#" 
                      className="w-12 h-12 bg-dark-900 rounded-full flex items-center justify-center text-gray-400 hover:text-cyan-400 hover:shadow-neon-cyan transition-all duration-300 hover:-translate-y-1"
                      aria-label="LinkedIn"
                    >
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <a 
                      href="#" 
                      className="w-12 h-12 bg-dark-900 rounded-full flex items-center justify-center text-gray-400 hover:text-pink-400 hover:shadow-neon-pink transition-all duration-300 hover:-translate-y-1"
                      aria-label="Twitter"
                    >
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div className="mt-8 relative">
                  ...
                  <div className="absolute -bottom-5 -left-5 w-16 h-16 bg-gradient-to-br from-pink-500/20 to-purple-500/20 rounded-full blur-xl animate-pulse-slow" style={{animationDelay: '1s'}}></div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="reveal" style={{ animationDelay: '0.3s' }}>
            <div className="h-full glass-dark p-8 rounded-xl border border-cyan-500/20 shadow-lg hover:shadow-cyan-500/5 transition-all duration-500">
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                {/* Form status message */}
                {formStatus.info.msg && (
                  <div className={`p-4 rounded-lg ${formStatus.info.error ? 'bg-pink-500/10 text-pink-400 border border-pink-500/20' : 'bg-cyan-500/10 text-cyan-400 border border-cyan-500/20'} animate-fade-in`}>
                    {formStatus.info.msg}
                  </div>
                )}
                
                <div className="group">
                  <label htmlFor="name" className="block text-gray-400 mb-2 group-focus-within:text-cyan-400 transition-colors duration-300">Name</label>
                  <input 
                    type="text" 
                    id="name" 
                    value={formData.name}
                ...
                <div className="group">
                  <label htmlFor="email" className="block text-gray-400 mb-2 group-focus-within:text-cyan-400 transition-colors duration-300">Email</label>
                  <input 
                    type="email" 
                    id="email" 
                ...
                <div className="group">
                  <label htmlFor="message" className="block text-gray-400 mb-2 group-focus-within:text-cyan-400 transition-colors duration-300">Message</label>
                  <textarea 
                    id="message" 
                    rows="5" 
                ...
                <button 
                  type="submit" 
                  className="w-full relative overflow-hidden group bg-gradient-cyan text-white font-medium py-3.5 rounded-lg transition-all duration-300 hover:shadow-neon-cyan transform hover:-translate-y-1 disabled:opacity-70 disabled:cursor-not-allowed disabled:transform-none disabled:hover:shadow-none"
